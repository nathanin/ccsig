...
adata_path = '/home/ingn/KnottLab/bladder/BladderGEX_run2_working.h5ad'
receptor_adata_path = '/home/ingn/KnottLab/bladder/receptor_scoring/receptor_genelists_2020_06_30_scores.h5ad'
...
P = np.load('/home/ingn/KnottLab/bladder/interactions/cabello_aguilar_matrix.npy')
RECEPTORS = np.array([l.strip() for l in open('/home/ingn/KnottLab/bladder/interactions/cabello_aguilar_receptors.txt')])
LIGANDS = np.array([l.strip() for l in open('/home/ingn/KnottLab/bladder/interactions/cabello_aguilar_ligands.txt')])

# Load a dictionary with keys ~ Receptors, and values ~ ligands
rl_pairs = pickle.load(open("/home/ingn/KnottLab/bladder/interactions/cabello_aguilar_dict.pkl", "rb"))
