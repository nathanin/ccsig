...
# TODO this dependency needs to disappear. 
# implement the interaction potential scoring logic in a util
from nichenetpy import plot_interactions
from interaction_util import interaction_score
...
def _process_permutation(r_adata_in, adata_in, receptor, labels, samples, interaction_kw_args):
  ...
  #   **interaction_kw_args
  # )
  _, _, I_tmp = interaction_score([receptor], r_adata_in, adata_in, 
    **interaction_kw_args
  )
...
def run_interaction_test(receptor, return_null_data=False, permutations=50, 
  ...
  I_test = calc_interactions([receptor], r_adata_in, adata_in, )
  #   **interaction_kw_args
  # )
